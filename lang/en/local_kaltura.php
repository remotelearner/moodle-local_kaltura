...
$string['metadata_profile_id'] = 'Metadata profile id';
$string['metadata_profile_id_desc'] = 'The metadata profile id used by the repository plug-in (This setting is used for migration purposes).';
